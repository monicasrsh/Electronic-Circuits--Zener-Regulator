...
## AIM:
To implement and simulate a Zener Voltage regulator and to obtain the output for variable loads and variable input voltages.
## APPARATUS REQUIRED:
...
34.	
35.	Tabulate the voltages and load currents and obtain the graphs.
